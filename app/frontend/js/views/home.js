...
export function homeView(container) {
  container.innerHTML = `
    <div class="home-dashboard" id="home-dashboard">
      <section class="knowledge-hero" aria-labelledby="knowledge-hero-title">
        <div>
          <span class="knowledge-kicker">PERSONAL FINANCE KNOWLEDGE SYSTEM</span>
          <h1 id="knowledge-hero-title">배우고, 찾아보고, 검증하는 금융지식 시스템</h1>
          <p>3주간의 금융상품·투자분석·퀀트 학습을 10개 단원으로 재구성했습니다. 단원에서 개념을 익힌 뒤 RAG로 근거를 찾고, 분석도구와 백테스트로 가정을 확인합니다.</p>
          <div class="knowledge-actions">
            <button type="button" onclick="navigate('learn-unit-01')"><i class="fa-solid fa-book-open"></i> 1단원부터 학습</button>
            <button type="button" class="secondary" onclick="navigate('rag-chat')"><i class="fa-solid fa-comments"></i> RAG에 질문</button>
          </div>
        </div>
        <div class="knowledge-flow" aria-label="학습 흐름">
          <span><b>1</b> 10단원 핵심 개념 학습</span>
          <span><b>2</b> RAG 근거 문서 검색</span>
          <span><b>3</b> 시장·기업·포트폴리오 분석</span>
          <span><b>4</b> 백테스트와 리스크 검증</span>
        </div>
      </section>
